    ...
    <div id="bou-settings-bloat" class="postbox boubox first-boubox">
        ...
        <div class="inside">
            ...
            bu_render_settings_block(array(
                ...
                'savings' => __('Approximately 20KB of savings, plus removal of CDN calls.'),
                'setting_id' => 'emojis',
